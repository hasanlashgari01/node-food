const UserMessage = {
    ...
    CurrentPasswordIsWrong: "کلمه عبور فعلی اشتباه است",
    PasswordUpdateSuccess: "کلمه عبور با موفقیت به روز شد",
    PasswordUpdateFailed: "به روز رسانی کلمه عبور با مشکل مواجه شد",
