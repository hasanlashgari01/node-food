const OrderMessage = {
    ...
    OrderNotDelivered: "سفارش ارسال نشده است",
    ParameterNotValid: "پارامتر های ارسالی صحیح نمی باشد",
    StatusNotValid: "پارامتر (وضعیت) صحیح نمی باشد",
    DeliveryStatusNotValid: "پارامتر (وضعیت ارسال) صحیح نمی باشد",
    PaymentNotValid: "پارامتر (پرداخت) صحیح نمی باشد",
    PaymentStatusNotValid: "پارامتر (وضعیت پرداخت) صحیح نمی باشد",
